...
L4.Image = "rbxassetid://83844722209947"
L1.Name = "MainGui"
...
local Window = Fluent:CreateWindow({
    Title = "Max Hub - Meme Sea",
    SubTitle = "• By Max Hub Team",
    TabWidth = 140,
        ...
        Callback = function()
            ...
            for i, v in pairs(a) do
                if not game:GetService("Players").LocalPlayer.Code:FindFirstChild(i) then
                    ...
                    notify("Xyris Hub Notifcation", "Code: " .. i .. " Used", 10)
                end
            end
        end
    })
        ...
        while wait() do
            if Config.PopCat then
                if game:GetService("Players").LocalPlayer.Items.Weapon.Popcat.Value == 0 then
                    ...
                    notify("Xyris Hub Notification", "You Have PopCat Sword", 10)
        ...
        while wait() do
            if Config.CoolQuest then
                if game:GetService("Players").LocalPlayer.Items.Weapon.Floppa.Value == 0 then
                    ...
                    notify("Xyris Hub Notification", "You Have Floppa Sword", 10)
        ...
        while wait() do
            if Config.MemeBeast then
                ...
                if MemeBeast and not getnameraid() and  game:GetService("Players").LocalPlayer.PlayerGui.RaidGui.RaidFrame.TimeLeft.Visible == false then
                    notify("Xyris Hub Notifcation", "Meme Beast Spawned", 10)
                    Tp(MemeBeast)
                    click = true
                    repeat
                        task.wait()
